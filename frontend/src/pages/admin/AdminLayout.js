...
import { BarChart3, Users, Package, Settings, Activity, LogOut, Menu, X, Image, FolderOpen } from 'lucide-react';

const NAV = [{ to: '/admin', label: 'Analytics', icon: BarChart3, end: true }, { to: '/admin/leads', label: 'Leads', icon: Users }, { to: '/admin/orders', label: 'Orders', icon: Package }, { to: '/admin/projects', label: 'Projects', icon: FolderOpen }, { to: '/admin/showcase', label: 'Showcase', icon: Image }, { to: '/admin/settings', label: 'Settings', icon: Settings }, { to: '/admin/tracking', label: 'Tracking', icon: Activity }];
