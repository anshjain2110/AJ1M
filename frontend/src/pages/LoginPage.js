...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--lj-bg)' }}>
      <header className="px-4 py-3 flex items-center" style={{ borderBottom: '1px solid var(--lj-border)' }}><a href="/"><img src="/logo-main.png" alt="The Local Jewel" className="h-10 object-contain" /></a></header>
