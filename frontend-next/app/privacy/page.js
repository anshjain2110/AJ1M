...
export const metadata = {
  ...
  description: 'Privacy Policy for The Local Jewel — how we collect, use, and protect your information.',
...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen" style={{ background: 'var(--lj-bg)' }} data-testid="privacy-page">
